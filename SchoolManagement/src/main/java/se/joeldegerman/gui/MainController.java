...
public class MainController {
	...
	public void openStudents(ActionEvent event) {
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/se/joeldegerman/gui/Student.fxml"));
	...
	public void openCourses(ActionEvent event) {
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/se/joeldegerman/gui/Course.fxml"));
			Stage stage = new Stage();
	...
	public void openTeachers(ActionEvent event) {
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/se/joeldegerman/gui/Teacher.fxml"));
			Stage stage = new Stage();
	...
	public void openEducation(ActionEvent event) {
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/se/joeldegerman/gui/Education.fxml"));
			Stage stage = new Stage();
	...
	public void openSchoolInformation(ActionEvent event) {
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/se/joeldegerman/gui/SchoolInformation.fxml"));
			Stage stage = new Stage();
